...
<img src="YuanX.png" width="50%" height="50%">
  
# Final Milestone

The final milestone for the FireWalker Sneakers project involves fully assembling and integrating all components into the shoe. First, a shoe must be selected with enough space to hold the microcontroller, battery pack, sensors, and wiring. Pressure sensors are carefully placed under the insole or secured with hot glue or tape to ensure they stay in position. The LED strips are then mounted securely along the shoe's surface, and all wires are connected and neatly tucked away to avoid discomfort or tangling. Finally, the full system is tested to make sure the lights respond correctly to pressure when walking, confirming that the project functions as intended.

# Challehges Faced(Final Milestone)
...
<img src="project.png" width="50%" height="50%">
# Schematics 
